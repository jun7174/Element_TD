...
namespace ElementTD
{
    ...
    // 발사 이후에는 값이 바뀌지 않으며, 명중 시점에 대상 몬스터의 저항 배율만 추가로 계산해서 적용한다.
    public struct AttackPayload
    {
        ...
        public AttackPayload(float baseDamage, ElementType element, bool isCriticalHit)
        {
        ...
        public void ApplyTo(MonsterBase target)
        {
            ...
            float finalDamage = DamageCalculator.CalculateFinalDamage(BaseDamage, 1f, monsterResistanceMultiplier);

...
namespace Beautify.Universal {
    ...
    public partial class BeautifyRendererFeature : ScriptableRendererFeature {
        ...
        partial class BeautifyRenderPass : ScriptableRenderPass {
            ...
            public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData) {
                ...
                using (var builder = renderGraph.AddUnsafePass<PassData>("Beautify Pass RG", out var passData)) {
                    ...
                    builder.SetRenderFunc((PassData passData, UnsafeGraphContext context) => {
                        ...
                        if (sourceDesc.width <= 0) sourceDesc.width = 1;
                        if (sourceDesc.height <= 0) sourceDesc.height = 1;
            ...
            static void ExecutePass (PassData passData) {
                ...
                if (usesSeparateOutline && !BeautifySettings.outlineBeforeTransparents && beautify.outlineStageParameter.value == OutlineStage.BeforeBloom) {
                ...
                if (usesSeparateOutline && !BeautifySettings.outlineBeforeTransparents && beautify.outlineStageParameter.value == OutlineStage.AfterBloom) {
                    DoSeparateOutline(cmd);
                }
...
#pragma warning restore 0618
            ...
            static void DoBloomAndFlares (CommandBuffer cmd, bool dofAffectsBloom) {
                ...
                RenderTargetIdentifier source = dofAffectsBloom && dofGlobalRT != null ? dofGlobalRT : BeautifyRenderPass.source;
            ...
            static void DoDoF (CommandBuffer cmd) {
                ...
                if (dofGlobalRT == null || dofGlobalRT.rt == null || dofGlobalRT.rt.width != dofDesc.width || dofGlobalRT.rt.height != dofDesc.height) {
                    dofGlobalRT?.Release();
                    dofGlobalRT = RTHandles.Alloc(dofDesc.width, dofDesc.height, colorFormat: UnityEngine.Experimental.Rendering.GraphicsFormat.R16G16B16A16_SFloat, filterMode: FilterMode.Bilinear, name: "_DoFTexRT");
                }
                FullScreenBlit(cmd, source, dofGlobalRT, bMat, (int)Pass.DoFCoC);

                if (beautify.depthOfFieldForegroundBlur.value && beautify.depthOfFieldForegroundBlurHQ.value) {
                    BlurThisAlpha(cmd, dofDesc, dofGlobalRT, beautify.depthOfFieldForegroundBlurHQSpread.value);
                }
                ...
                if (beautify.depthOfFieldBokehComposition.value == Beautify.DoFBokehComposition.Integrated || !beautify.depthOfFieldBokeh.value) {
                    ...
                    BlurThisDoF(cmd, dofDesc, dofGlobalRT, (int)pass);
                }
                else {
                    BlurThisDoF(cmd, dofDesc, dofGlobalRT, (int)Pass.DoFBlurWithoutBokeh);
                    ...
                    FullScreenBlit(cmd, ShaderParams.dofBokehRT, dofGlobalRT, bMat, (int)Pass.DoFAdditive);
                    cmd.ReleaseTemporaryRT(ShaderParams.dofBokehRT);
                }


                cmd.SetGlobalTexture(ShaderParams.dofRT, dofGlobalRT);
            }

            static void BlurThisDoF (CommandBuffer cmd, RenderTextureDescriptor dofDesc, RenderTargetIdentifier rt, int renderPass) {
            ...
            static void BlurThisAlpha (CommandBuffer cmd, RenderTextureDescriptor dofDesc, RenderTargetIdentifier rt, float blurScale = 1f) {
            ...
            internal static void ExecuteOutlineBeforeTransparents(CommandBuffer cmd) {
                if (bMat == null || beautify == null || !usesSeparateOutline) return;
                DoSeparateOutline(cmd);
            }

            internal static bool CanExecuteOutlineBeforeTransparents => bMat != null && beautify != null && usesSeparateOutline && BeautifySettings.outlineBeforeTransparents;
            ...
            public void UpdateMaterialProperties (Camera cam) {
                ...
                if (canUseDepthTexture) {
                    ...
                    if (beautify.outline.value) {
                        ...
                        BeautifySettings.outlineBeforeTransparents = usesSeparateOutline && beautify.outlineStageParameter.value == OutlineStage.BeforeTransparents;
        ...
        partial class BeautifySharpenExclusionMaskPass : ScriptableRenderPass {
        ...
        partial class BeautifyBloomLumMaskPass : ScriptableRenderPass {
        ...
        partial class BeautifyAnamorphicFlaresLumMaskPass : ScriptableRenderPass {
        ...
        internal partial class BeautifyDoFTransparentMaskPass : ScriptableRenderPass {
        ...
        partial class BeautifyOutlineDepthPrepass : ScriptableRenderPass {
        ...
        partial class BeautifyClearColorTarget : ScriptableRenderPass {
        ...
        partial class BeautifyOutlineEffectPass : ScriptableRenderPass {

            const string m_ProfilerTag = "Beautify Outline Effect";

            public BeautifyOutlineEffectPass() {
                renderPassEvent = RenderPassEvent.BeforeRenderingTransparents;
            }
        ...
        BeautifyOutlineEffectPass m_BeautifyOutlineEffectPass;
        ...
        public override void Create () {
            ...
            m_BeautifyOutlineEffectPass = new BeautifyOutlineEffectPass();
        ...
        public override void AddRenderPasses (ScriptableRenderer renderer, ref RenderingData renderingData) {
            ...
            if (ignorePostProcessingOption || renderingData.cameraData.postProcessEnabled) {
                ...
                if (m_BeautifyRenderPass.Setup(shader, renderer, renderingData, renderPassEvent, ignorePostProcessingOption)) {
                    ...
                    if (BeautifySettings.outlineBeforeTransparents) {
                        renderer.EnqueuePass(m_BeautifyOutlineEffectPass);
                    }

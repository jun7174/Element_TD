...
namespace Beautify.Universal {
    ...
    public class Beautify : VolumeComponent, IPostProcessComponent {
        ...
        [ImageEnhancement, Sharpen, DisplayName("Exclusion Layers"), Tooltip("Layers to exclude from sharpening."), ShowStrippedLabel]
        public BeautifyLayerMaskParameter sharpenExclusionLayerMask = new BeautifyLayerMaskParameter { value = 0 };
        ...
        [Tooltip("Optional offset in front of the focal plane. Foreground blur is based on each pixel's distance from the focal plane; this value reduces blur for objects within this distance in front of the plane. Set to 0 for no offset.")]
        ...
        public ColorParameter frameColor = new ColorParameter(new Color(1, 1, 1, 1));

        [ArtisticChoices, Frame, DisplayName("Thickness"), DisplayConditionEnum("frameStyle", (int)FrameStyle.Border)]
        public ClampedFloatParameter frameThickness = new ClampedFloatParameter(0.047f, 0, 1);

        [ArtisticChoices, Frame, DisplayName("Sharpness"), DisplayConditionEnum("frameStyle", (int)FrameStyle.Border)]
        public ClampedFloatParameter frameSharpness = new ClampedFloatParameter(50f, 1f, 255f);

        [ArtisticChoices, Frame, DisplayName("Texture Mask"), ShowStrippedLabel]
